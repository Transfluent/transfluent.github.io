...
angular.module('transfluentAPI', [
  ...
  function ($interpolateProvider, $translateProvider) {
    ...
    $translateProvider.translations('en', {
      ...
      'api-meta-parameter': 'An array of metadata fields associated to the order. <code>project_title</code> is only publicly available field. It may be an internal reference, it is displayed in reporting and order details. <code>po</code> is field for Purchase Order -number (or reference), but it MUST be activated for your account before using it.',
